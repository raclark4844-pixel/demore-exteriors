...
export default function ContactSection({ mode = "estimate" }) {
  ...
  const handleSubmit = async (e) => {
    ...
    await base44.entities.ContactLead.create({
      ...form,
      ...(inspectionMode ? { description: "Homepage hero inspection request" } : {}),
    });
    setSubmitting(false);
    setSubmitted(true);
  };
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto text-lg">
            {inspectionMode
              ? "Free, no-obligation inspection for Northeast Ohio homeowners. We’ll assess your project and provide a written estimate."
        ...
        <div className="grid lg:grid-cols-5 gap-12">
            ...
            {submitted ? (
              <div className="bg-card border border-primary/30 rounded-2xl p-12 text-center">
                ...
                <p className="text-muted-foreground">
                  {inspectionMode
                    ? "We’ve received your request and will contact you to schedule your free inspection. After the inspection, we’ll provide a written estimate."
              ...
              <form onSubmit={handleSubmit} className="bg-card border border-border/50 rounded-2xl p-6 sm:p-8 space-y-5">
                ...
                <div className={`grid ${inspectionMode ? "sm:grid-cols-1" : "sm:grid-cols-2"} gap-5`}>
                  {!inspectionMode && (
                    <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="address" className="text-sm font-medium">{inspectionMode ? "City or ZIP *" : "Property Address"}</Label>
                  <Input
                    id="address"
                    required={inspectionMode}
                    placeholder={inspectionMode ? "Mentor, OH 44060" : "123 Main St, Mentor, OH 44060"}
                    value={form.address}
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="message"
                    rows={4}
                    placeholder="Describe your project or damage..."
                    value={form.message}
                ...
                <Button
                  ...
                  disabled={submitting}
                  size="lg"
                  className="w-full bg-accent text-accent-foreground hover:bg-accent/90 font-heading font-bold text-base h-14"
                >
          ...
          >
              ...
              <div className="space-y-4">
                <a href="tel:4409206133" className="flex items-start gap-3 group">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Mon–Sat, 7AM–7PM</p>
                  </div>
                </a>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium">6348 Meldon Dr</p>
                    <p className="text-xs text-muted-foreground">Mentor, OH 44060</p>
                  </div>
                </div>
                ...
                <a href="mailto:ryan@demoreexteriorsolutions.com" className="flex items-start gap-3 group">
                  ...
                  <div>
                    <p className="text-sm font-medium group-hover:text-primary transition-colors">ryan@demoreexteriorsolutions.com</p>
            ...
            <div className="bg-card border border-border/50 rounded-2xl p-6">
              ...
              <div className="flex gap-2 mb-3">
                {["Residential", "Commercial"].map((type) => (
                  <button
                    key={type}
                    onClick={() => setAreaTab(type)}
                    className={`text-xs px-3 py-1 rounded-full font-heading font-semibold transition-colors ${
                      areaTab === type ? "bg-primary text-primary-foreground" : "bg-secondary text-muted-foreground hover:text-primary"
                    }`}
                  >
                    {type}
                  </button>
              ...
              <p className="text-xs text-muted-foreground mb-2">
                Click a county to explore {areaTab.toLowerCase()} services:
              </p>
              <div className="flex flex-wrap gap-1.5">
                {[
                  { name: "Cuyahoga", slug: "cuyahoga" },
                  { name: "Lake", slug: "lake" },
                  ...
                  <Link
                    ...
                    className="text-xs bg-primary/10 text-primary px-2 py-1 rounded-full font-medium hover:bg-primary hover:text-primary-foreground transition-colors"
                  >
                    {county.name} County
                  </Link>
                ))}
            ...
            <div className="bg-card border border-primary/20 rounded-2xl p-6 text-center">
              ...
              <p className="text-xs text-muted-foreground mb-3">Call us immediately for priority service</p>
              <a href="tel:4409206133">
                <Button className="bg-primary hover:bg-primary/90 font-heading font-bold w-full">
